...
| 2026-08-06 | 1.1.0 | **DIRECTIVE-19 — instrument preparation, register correction, study pre-registration.** §3.1: Register entries 7, 9, 10 corrected with supersession dates. Standing instruction added (every entry carries establishing + revising directive). §3.2: Attribution matcher built (brand + part number from title + SKU). Coverage 75.4%, FPR 0.0%, 60 same-part + 50 near-miss pairs. §3.3: MAP rarefaction — partition saturates at ~70% of 25K, extrapolation to 102K estimates ~13K queries. Subimods selection error — 91% of absent in cells with recovery (within-cell problem). §3.4: Same-day noise floor (running). §3.5: Store-selection rule pre-registered (independent frame, seed=42). §4.2: Design question — Allocation A vertical CI 13.6pp, Allocation B 10.4pp. §5.1: Outreach scaled to 25 contacts, BRAND 3 rewritten, disclosure added. §5.3: Stores named in paper, notified before publication (C9 amended). §5.5: €500 Gate A tier removed, G3 reconciled at 25 contacts. |
